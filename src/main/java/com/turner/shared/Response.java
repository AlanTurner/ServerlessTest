...
// ** Note - autogenerated response object from serverless. **
...
public class Response {
    ...
    public Response(final int statusCode, final String body, final Map<String, String> headers, final boolean isBase64Encoded) {
